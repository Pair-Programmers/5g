...
<body>
    ...
    <?=$sidebar; ?>
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <form method="post" class="form-horizontal" action="{{route('sale_order_update')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="date" class="form-control has-error" name="date" value="{{$sale_order->date}}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="number" class="form-control " name="discount" value="{{$sale_order->discount}}">
                                </div>

                                <label class="col-sm-1 control-label">Ref #</label>

                                <div class="col-sm-2">
                                    <input type="number" class="form-control" name="reference_no" placeholder="Optional" value="{{$sale_order->reference_no}}">
                                </div>

                                    <label class="col-sm-1 control-label">Description</label>

                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="description" placeholder="Optional" value="{{$sale_order->description}}">
                                </div>
                        ...
                        <div class="ibox-content">
                            ...
                            <button  class="btn btn-primary" type="submit" name="button" value="Update Invoice">Update Invoice</button>
