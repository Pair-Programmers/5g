        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{URL::to('product_category_store')}}" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="ibox float-e-margins">
                    ...
                    @foreach($categories as $category)
                        <tr class="gradeX">
                            ...
                            <td>
                                <a href="{{ url('/display_edit_exp_category', ['id' => $category->id]) }}">
                                    <small class="label label-primary"><i class="fa"></i>Edit</small>
                                </a>
                                <a href="{{ url('/product_category_destroy', ['id' => $category->id]) }}">
